import {GLOBAL, NO_DOMAIN, PRIVATE, PRIVATE_LOCAL, PUBLIC} from "./consts";
import {pack_value} from "./aspect";
    ...
    if (search_config.include.aspect_search) {
      ...
      if (etype.rules.hasOwnProperty("search_in")) {
        ...
        for (let aspect_loc_str of search_in) {
          try {
            console.warn("aspect_search currently not supported cuy of aspect_loc refactor")
