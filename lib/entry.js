...
export function MAspectComponent(aspect, ignore_page = false, clearAlt = false, mode = EDIT) {
  console.log(aspect, ignore_page, clearAlt, mode)
...
export async function fetch_entry(store, axios, uuid) {
  ...
  entry.aspects_value = entry.content.aspects
