...
export const ENTRIES_SET_REF_PARENT = "entries/set_ref_parent"
export const ENTRIES_ADD_REF_CHILD = "entries/add_ref_child"
export const ENTRIES_EDIT_ADD_REF_CHILD = "entries/add_edit_ref_child"
...
export const ENTRYTYPES_NOTES = "entrytypes/note"
...
export const MAP_GOTO_LOCATION = "map/goto_location"
...
export const ENTRIES_GET_PROPER_MODE = "entries/get_proper_mode"
...
//SEARCH
// todo name should be: search_entries
export const ENTRIES_SEARCH = "search/get_entries"
export const CLEAR_SEARCH = "search/clear"
export const SET_ENTRIES = "search/set_entries"
