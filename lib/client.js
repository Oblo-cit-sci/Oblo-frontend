...
import {CONNECTING, CONNECTION, DB_LOADED, DOMAIN, INIT, SET_DOMAIN, USER_LOGGED_IN} from "./store_consts";
...
import {
  SEARCH_APPEND_ENTRIES, SEARCH_INCREASE_COUNT,
  SEARCH_PREPEND_ENTRIES,
  SEARCH_SET_ENTRIES,
  SEARCH_SET_SEARCH_COUNT, SEARCH_SET_SEARCHTIME
} from "~/store/search";
