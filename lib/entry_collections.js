...
import {DRAFT, PRIVATE_LOCAL, REGULAR, TYPE_SLUG} from "~/lib/consts";
...
export function compare_entries(entry1, entry2) {

  // ld.isEqual(entry1.tags, entry2.tags)
  // location
  const results = []
  if (entry1.privacy !== entry2.privacy) {
    console.log(entry1.privacy, entry2.privacy)
    results.push(Mustache.render(entry_changes.privacy, {old: entry1.privacy, new: entry2.privacy}))
  }
